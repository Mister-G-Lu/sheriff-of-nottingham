...
class TestPrintIntro:
    ...
    def test_print_intro_with_json_file(self, mock_file, mock_print):
        ...
        with patch("json.load", return_value=mock_intro_data):
            ...
            assert any(
                "Welcome to the game" in str(call) for call in mock_print.call_args_list
            )
    ...
    def test_print_intro_without_pygame(self, mock_print):
        ...
        mock_intro_data = {"title": "Test Title", "intro": "Test intro text"}
    ...
    def test_print_intro_with_custom_title(self, mock_print):
        ...
        mock_intro_data = {"title": "Custom Game Title", "intro": "Custom intro text"}
        ...
        with patch("builtins.open", mock_open()):
            with patch("json.load", return_value=mock_intro_data):
                ...
                assert any(
                    "Custom Game Title" in str(call)
                    for call in mock_print.call_args_list
                )
                assert any(
                    "Custom intro text" in str(call)
                    for call in mock_print.call_args_list
                )
    ...
    def test_print_intro_empty_intro_text(self, mock_print):
        ...
        mock_intro_data = {"title": "Sheriff of Nottingham", "intro": ""}
