...
from core.mechanics.goods import Good, ALL_LEGAL, ALL_CONTRABAND, APPLE, CHEESE, BREAD, CHICKEN, SILK, PEPPER, MEAD, CROSSBOW
from core.mechanics.inspection import handle_inspection, handle_pass_without_inspection
from core.game.rounds import Declaration, RoundState
...
class TestInspection(unittest.TestCase):
    ...
    def test_handle_inspection_with_contraband(self):
        ...
        merchant = create_test_merchant(gold=50, bluff_skill=1)  # Low bluff to ensure caught
...
class TestRoundState(unittest.TestCase):
    ...
    def test_round_state_inspection(self):
        ...
        self.assertEqual(rs.contraband_found_value, 6)
...
class TestMerchant(unittest.TestCase):
    ...
    def test_merchant_record_round(self):
        ...
        self.assertEqual(summary["contraband_passed_value"], 6)
