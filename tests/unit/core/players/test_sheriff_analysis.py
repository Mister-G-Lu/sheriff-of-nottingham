...
class TestDetailedAnalysis(unittest.TestCase):
    ...
    def test_inspection_rate_calculation(self):
        ...
        history = [
            {'declaration': {'good_id': 'apple', 'count': 1}, 
             'actual_ids': ['apple'], 'caught_lie': False, 'opened': True},
            {'declaration': {'good_id': 'cheese', 'count': 1}, 
             'actual_ids': ['cheese'], 'caught_lie': False, 'opened': False},
            {'declaration': {'good_id': 'bread', 'count': 1}, 
             'actual_ids': ['bread'], 'caught_lie': False, 'opened': False},
            {'declaration': {'good_id': 'chicken', 'count': 1}, 
             'actual_ids': ['chicken'], 'caught_lie': False, 'opened': False}
        ]
    ...
    def test_aggressive_sheriff(self):
        ...
        history = [
            {'declaration': {'good_id': 'apple', 'count': 1}, 
             'actual_ids': ['silk'], 'caught_lie': True, 'opened': True},
            {'declaration': {'good_id': 'cheese', 'count': 1}, 
             'actual_ids': ['cheese'], 'caught_lie': False, 'opened': True},
            {'declaration': {'good_id': 'bread', 'count': 1}, 
             'actual_ids': ['pepper'], 'caught_lie': True, 'opened': True}
        ]
    ...
    def test_lenient_sheriff(self):
        ...
        history = [
            {'declaration': {'good_id': 'apple', 'count': 1}, 
             'actual_ids': ['silk'], 'caught_lie': False, 'opened': False},
            {'declaration': {'good_id': 'cheese', 'count': 1}, 
             'actual_ids': ['pepper'], 'caught_lie': False, 'opened': False}
        ]
