...
from ai_strategy.ai_sheriffs import corrupt_greedy, smart_adaptive, trigger_happy
...
def main():
    ...
    for sheriff_name, sheriff_strategy in sheriff_strategies.items():
        ...
        for merchant in test_merchants:
            ...
            print(
                f"  Stats: Honesty={merchant.honesty_bias}, Risk={merchant.risk_tolerance}, "
            ...
            for round_num in range(100):
                try:
                    ...
                    if hasattr(declaration, "strategy"):
                        strategy_counts[declaration.strategy] = (
                            strategy_counts.get(declaration.strategy, 0) + 1
                        )
                    elif is_honest:
                    ...
                    declared_goods = [
                        GOOD_BY_ID[declaration.good_id]
                    ] * declaration.count
                    bribe_offered = 0
            ...
            print(
                f"    Bribes Accepted: {stats.bribes_accepted} ({stats.bribes_accepted / stats.bribes_attempted * 100:.0f}%)"
                if stats.bribes_attempted > 0
                else "    Bribes Accepted: 0 (0%)"
            )
