...
from ui.pygame_window import (
    BLACK, WHITE, GREEN, DARK_GREEN, GRAY, DARK_GRAY,
...
class PygameInput:
    ...
    def get_input(self, prompt: str = "") -> str:
        ...
        self.text_display.display_text(f"> {result}", clear_previous=False, animate=False)
    ...
    def show_choices(self, prompt: str, choices: List[Tuple[str, str]]) -> str:
        ...
        while selected is None:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    for i, (choice_text, rect) in enumerate(self.choice_buttons):
        ...
        self.text_display.display_text(f"> {selected_display}", clear_previous=False, animate=False)
    ...
    def wait_for_continue(self):
        ...
        self.text_display.display_text("[Click anywhere or press any key to continue]", 
                                      clear_previous=False, animate=False)
    ...
    def _render_with_input(self):
        ...
        if self.waiting_for_input and self.input_prompt:
            ...
            visible_lines = len(self.text_display.text_lines[self.text_display.text_scroll_offset:])
            ...
            if y_offset + 70 < TEXT_BOX_Y + TEXT_BOX_HEIGHT:
                prompt_surface = self.window.font_normal.render(self.input_prompt, True, GREEN)
                self.window.screen.blit(prompt_surface, (TEXT_BOX_X + 20, y_offset + 10))
