...
class VisualNovelUI:
    ...
    def __init__(self):
        ...
        self.price_menu = PriceMenu(self.window.screen, self.window.font_normal, self.window.font_small)
    ...
    def update_stats(self, sheriff=None, stats=None, merchant_count: int = 0, total_merchants: int = 0):
