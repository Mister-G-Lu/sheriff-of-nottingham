"""
Sheriff of Nottingham prototype — entry point.
Run from project root: python main.py
"""
import random

from core.merchants import load_merchants
from core.sheriff import Sheriff
from core.rounds import Declaration, resolve_inspection
from core.goods import GOOD_BY_ID, ALL_LEGAL, ALL_CONTRABAND
from ui.narration import narrate_arrival, show_declaration, show_bribe, show_inspection_result


def main() -> None:
    print("=== Sheriff of Nottingham (prototype) ===\n")
